...
THUMBNAIL_ENGINE = 'dummy_thumbnails.' \
                   'contrib.' \
                   'thumbnailers.' \
                   'sorl_thumbnail.' \
                   'engines.' \
...
LOGGING = {
    ...
    'handlers': {
        ...
        'dummy_thumbnails_log': {
            'level': 'DEBUG',
            'class': 'logging.handlers.RotatingFileHandler',
            'filename': PROJECT_DIR("../../logs/dummy_thumbnails.log"),
            'maxBytes': 1048576,
            'backupCount': 99,
            'formatter': 'verbose',
        },
    ...
    'loggers': {
        ...
        'dummy_thumbnails': {
            'handlers': ['console', 'dummy_thumbnails_log'],
            'level': 'DEBUG',
            'propagate': True,
        },
    },
...
# installation.
if DEV:
    dummy_thumbnails_source_path = os.environ.get(
        'DUMMY_THUMBNAILS_SOURCE_PATH',
        'src'
    )
    # sys.path.insert(0, os.path.abspath('src'))
    sys.path.insert(0, os.path.abspath(dummy_thumbnails_source_path))
